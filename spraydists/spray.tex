...
We develop a method for synthetically recreating baseball players in order to alleviate the small sample size concerns of individual batter pitcher matchups. Our synthetic player creation method is %inspired by the mechanics of SCM introduced in \cite{abadie2010synthetic}. 
