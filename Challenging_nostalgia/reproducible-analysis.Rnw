...
<<pops, cache = TRUE, warnings = FALSE, errors = FALSE>>=
...
<<Taiwan, cache = TRUE, warnings = FALSE, errors = FALSE>>=
...
<<oldCanadaandUS, cache = TRUE, warnings = FALSE, errors = FALSE>>=
...
<<additionalcountries, cache = TRUE, warnings = FALSE, errors = FALSE>>=
# load in UN dataset and remove irrelevant variables
options(warn=-1)
WPP2010 <- 
  read.csv("WPP2010_DB4_F2A_POPULATION_BY_AGE_MALE_ANNUAL_1950-2010.csv", 
...
<<popsdata, cache = TRUE, warnings = FALSE, errors = FALSE>>=
...
<<basicinfo, cache = TRUE, warnings = FALSE, errors = FALSE>>=
options(scipen=999)
# proportion of MLB eligible population before who lived before 1950
p <- data[8, 3]
...
pranker10 <- pbinom(ranker10 - 1, p = p, size = 10, lower = FALSE)
pbWAR10   <- pbinom(bWAR10 - 1, p = p, size = 10, lower = FALSE)
pfWAR10   <- pbinom(fWAR10 - 1, p = p, size = 10, lower = FALSE)
pESPN10   <- pbinom(ESPN10 - 1, p = p, size = 10, lower = FALSE)

# binomial calculations for top 25 lists
pranker25 <- pbinom(ranker25 - 1, p = p, size = 25, lower = FALSE)
pbWAR25   <- pbinom(bWAR25 - 1, p = p, size = 25, lower = FALSE)
pfWAR25   <- pbinom(fWAR25 - 1, p = p, size = 25, lower = FALSE)
pESPN25   <- pbinom(ESPN25 - 1, p = p, size = 25, lower = FALSE)
@
...
<<weights, cache = TRUE>>=
# compute w1 based on information from 
# Gallup on baseball fans (50% fans before 1940)
w1 <- c(rep(0.5, 6), rep(0.4, 9))

# construct rewighted dataset with respect to w1
data.w1 <- data
data.w1[, 2] <- data.w1[, 2] * w1
data.w1[, 3] <- cumsum(data.w1[, 2]) / sum(data.w1[, 2])

# compute w2 based on information from 
# Gallup on baseball fans (60% fans before 1940)
w2 <- c(rep(0.6, 6), rep(0.4, 9))

# construct rewighted dataset with respect to w2
data.w2 <- data
data.w2[, 2] <- data.w2[, 2] * w2
data.w2[, 3] <- cumsum(data.w2[, 2]) / sum(data.w2[, 2])

# compute w3 based on information from 
# Gallup on favorite sport
w3 <- c(rep(0.4, 6), 0.35, 0.38, 0.34, 0.28, 0.16, 0.16, 0.13, 0.12, 0.10)

# construct rewighted dataset with respect to w3
data.w3 <- data
data.w3[, 2] <- data.w3[, 2] * w3
data.w3[, 3] <- cumsum(data.w3[, 2]) / sum(data.w3[, 2])

# construct rewighted dataset with respect to w4
w4 <- (w2 + w3) / 2
data.w4 <- data
...
<<weighted.analysis, cache = TRUE>>=
## Recompute extreme probabilities consistent with w1
p.w1 <- data.w1[8, 3]
pranker10.w1 <- pbinom(ranker10 - 1, p = p.w1, size = 10, lower = FALSE)
pbWAR10.w1   <- pbinom(bWAR10 - 1, p = p.w1, size = 10, lower = FALSE)
pfWAR10.w1   <- pbinom(fWAR10 - 1, p = p.w1, size = 10, lower = FALSE)
pESPN10.w1   <- pbinom(ESPN10 - 1, p = p.w1, size = 10, lower = FALSE)
pranker25.w1 <- pbinom(ranker25 - 1, p = p.w1, size = 25, lower = FALSE)
pbWAR25.w1   <- pbinom(bWAR25 - 1, p = p.w1, size = 25, lower = FALSE)
pfWAR25.w1   <- pbinom(fWAR25 - 1, p = p.w1, size = 25, lower = FALSE)
pESPN25.w1   <- pbinom(ESPN25 - 1, p = p.w1, size = 25, lower = FALSE)

## Recompute extreme probabilities consistent with w2
p.w2 <- data.w2[8, 3]
pranker10.w2 <- pbinom(ranker10 - 1, p = p.w2, size = 10, lower = FALSE)
pbWAR10.w2   <- pbinom(bWAR10 - 1, p = p.w2, size = 10, lower = FALSE)
pfWAR10.w2   <- pbinom(fWAR10 - 1, p = p.w2, size = 10, lower = FALSE)
pESPN10.w2   <- pbinom(ESPN10 - 1, p = p.w2, size = 10, lower = FALSE)
pranker25.w2 <- pbinom(ranker25 - 1, p = p.w2, size = 25, lower = FALSE)
pbWAR25.w2   <- pbinom(bWAR25 - 1, p = p.w2, size = 25, lower = FALSE)
pfWAR25.w2   <- pbinom(fWAR25 - 1, p = p.w2, size = 25, lower = FALSE)
pESPN25.w2   <- pbinom(ESPN25 - 1, p = p.w2, size = 25, lower = FALSE)

## Recompute extreme probabilities consistent with w3
p.w3 <- data.w3[8, 3]
pranker10.w3 <- pbinom(ranker10 - 1, p = p.w3, size = 10, lower = FALSE)
pbWAR10.w3   <- pbinom(bWAR10 - 1, p = p.w3, size = 10, lower = FALSE)
pfWAR10.w3   <- pbinom(fWAR10 - 1, p = p.w3, size = 10, lower = FALSE)
pESPN10.w3   <- pbinom(ESPN10 - 1, p = p.w3, size = 10, lower = FALSE)
pranker25.w3 <- pbinom(ranker25 - 1, p = p.w3, size = 25, lower = FALSE)
pbWAR25.w3   <- pbinom(bWAR25 - 1, p = p.w3, size = 25, lower = FALSE)
pfWAR25.w3   <- pbinom(fWAR25 - 1, p = p.w3, size = 25, lower = FALSE)
pESPN25.w3   <- pbinom(ESPN25 - 1, p = p.w3, size = 25, lower = FALSE)

## Recompute extreme probabilities consistent with w4
p.w4 <- data.w4[8, 3]
pranker10.w4 <- pbinom(ranker10 - 1, p = p.w4, size = 10, lower = FALSE)
pbWAR10.w4   <- pbinom(bWAR10 - 1, p = p.w4, size = 10, lower = FALSE)
pfWAR10.w4   <- pbinom(fWAR10 - 1, p = p.w4, size = 10, lower = FALSE)
pESPN10.w4   <- pbinom(ESPN10 - 1, p = p.w4, size = 10, lower = FALSE)
pranker25.w4 <- pbinom(ranker25 - 1, p = p.w4, size = 25, lower = FALSE)
pbWAR25.w4   <- pbinom(bWAR25 - 1, p = p.w4, size = 25, lower = FALSE)
pfWAR25.w4   <- pbinom(fWAR25 - 1, p = p.w4, size = 25, lower = FALSE)
pESPN25.w4   <- pbinom(ESPN25 - 1, p = p.w4, size = 25, lower = FALSE)
@
...
p.w5 <- data.w5[8, 3]
pranker10.w5 <- pbinom(ranker10 - 1, p = p.w5, size = 10, lower = FALSE)
pbWAR10.w5   <- pbinom(bWAR10 - 1, p = p.w5, size = 10, lower = FALSE)
pfWAR10.w5   <- pbinom(fWAR10 - 1, p = p.w5, size = 10, lower = FALSE)
pESPN10.w5   <- pbinom(ESPN10 - 1, p = p.w5, size = 10, lower = FALSE)
pranker25.w5 <- pbinom(ranker25 - 1, p = p.w5, size = 25, lower = FALSE)
pbWAR25.w5   <- pbinom(bWAR25 - 1, p = p.w5, size = 25, lower = FALSE)
pfWAR25.w5   <- pbinom(fWAR25 - 1, p = p.w5, size = 25, lower = FALSE)
pESPN25.w5   <- pbinom(ESPN25 - 1, p = p.w5, size = 25, lower = FALSE)
...
appears in the top 10 occurs with probability $p = \Sexpr{signif(p, 3)}$ 
