...
<<cache = TRUE, echo = FALSE>>=
# Information from Gallup on baseball fans (50% fans before 1930)
...
# Information from Gallup on baseball fans (60% fans before 1930)
...
Fan1880 <- Fan1890 <- Fan1900 <- Fan1910 <- Fan1920 <- Fan1930 <- 0.38
...
tab <- cbind(data[,1],w1,w2,w3,w4)
colnames(tab)[1] <- c("year")
print(xtable(tab, digits = c(0,0,2,2,2,2), 
